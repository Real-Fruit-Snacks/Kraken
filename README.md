...
Report vulnerabilities via [GitHub Security Advisories](https://github.com/Real-Fruit-Snacks/Kraken/security/advisories). 90-day responsible disclosure.

**Kraken does not:**
- Provide zero-day exploits or vulnerability scanners (not an exploit framework)
- Evade modern EDR/XDR behavioral analysis (research-grade, not production evasion)
- Include anti-forensics or log destruction capabilities
- Support unauthorized access to any system
